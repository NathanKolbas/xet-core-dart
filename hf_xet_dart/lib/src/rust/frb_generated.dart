...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 600660539;
...
abstract class RustLibApi extends BaseApi {
  Future<DartXetDownloadInfo> crateApiDartXetDownloadInfoNew({
    required String destinationPath,
    required String hash,
    required BigInt fileSize,
  });

  Future<DartXetUploadInfo> crateApiDartXetUploadInfoNew({
    required String hash,
    required BigInt fileSize,
  });

  Future<List<String>> crateApiDownloadFiles({
  ...
  Future<void> crateApiDartInitApp();

  Future<List<DartXetUploadInfo>> crateApiUploadBytes({
  ...
  Future<List<DartXetUploadInfo>> crateApiUploadFiles({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<DartXetDownloadInfo> crateApiDartXetDownloadInfoNew({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_xet_download_info,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiDartXetDownloadInfoNewConstMeta,
        argValues: [destinationPath, hash, fileSize],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiDartXetDownloadInfoNewConstMeta =>
      const TaskConstMeta(
        debugName: "dart_xet_download_info_new",
        argNames: ["destinationPath", "hash", "fileSize"],
      );
  ...
  Future<DartXetUploadInfo> crateApiDartXetUploadInfoNew({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_xet_upload_info,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiDartXetUploadInfoNewConstMeta,
        argValues: [hash, fileSize],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiDartXetUploadInfoNewConstMeta =>
      const TaskConstMeta(
        debugName: "dart_xet_upload_info_new",
        argNames: ["hash", "fileSize"],
      );
  ...
  Future<List<String>> crateApiDownloadFiles({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_list_dart_xet_download_info(files, serializer);
          sse_encode_opt_String(endpoint, serializer);
          sse_encode_opt_String(hfHome, serializer);
          sse_encode_opt_box_autoadd_record_string_u_64(tokenInfo, serializer);
          sse_encode_DartFn_Inputs__Output_dart_token_info_AnyhowException(
            tokenRefresher,
            serializer,
          );
        ...
        constMeta: kCrateApiDownloadFilesConstMeta,
        argValues: [
          files,
          endpoint,
          hfHome,
  ...
  TaskConstMeta get kCrateApiDownloadFilesConstMeta => const TaskConstMeta(
    debugName: "download_files",
    argNames: [
      "files",
      "endpoint",
      "hfHome",
  ...
  Future<void> crateApiHfXet({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiHfXetConstMeta,
        argValues: [dartVersion, hfXetVersion, huggingfaceHubVersion],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiHfXetConstMeta => const TaskConstMeta(
    debugName: "hf_xet",
    argNames: ["dartVersion", "hfXetVersion", "huggingfaceHubVersion"],
  );
  ...
  Future<void> crateApiDartInitApp() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDartInitAppConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDartInitAppConstMeta =>
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_String(repoType, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 6,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_dart_xet_upload_info,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiUploadBytesConstMeta,
        argValues: [
          fileContents,
          endpoint,
          hfHome,
  ...
  TaskConstMeta get kCrateApiUploadBytesConstMeta => const TaskConstMeta(
    debugName: "upload_bytes",
    argNames: [
      "fileContents",
      "endpoint",
      "hfHome",
  ...
  Future<List<DartXetUploadInfo>> crateApiUploadFiles({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiUploadFilesConstMeta,
        argValues: [
          filePaths,
          endpoint,
          hfHome,
  ...
  TaskConstMeta get kCrateApiUploadFilesConstMeta => const TaskConstMeta(
    debugName: "upload_files",
    argNames: [
      "filePaths",
      "endpoint",
      "hfHome",
  ...
  Future<void> Function(int)
  encode_DartFn_Inputs__Output_dart_token_info_AnyhowException(
    FutureOr<DartTokenInfo> Function() raw,
  ) {
    return (callId) async {
      Box<DartTokenInfo>? rawOutput;
      Box<AnyhowException>? rawError;
      try {
        rawOutput = Box(await raw());
      } catch (e, s) {
      ...
      if (rawOutput != null) {
        serializer.buffer.putUint8(0);
        sse_encode_dart_token_info(rawOutput.value, serializer);
      } else {
        serializer.buffer.putUint8(1);
        sse_encode_AnyhowException(rawError!.value, serializer);
      }
  ...
  @protected
  FutureOr<DartTokenInfo> Function()
  dco_decode_DartFn_Inputs__Output_dart_token_info_AnyhowException(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  ...
  DartXetDownloadInfo dco_decode_dart_xet_download_info(dynamic raw) {
    ...
    return DartXetDownloadInfo(
      destinationPath: dco_decode_String(arr[0]),
  ...
  @protected
  List<DartXetDownloadInfo> dco_decode_list_dart_xet_download_info(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_dart_xet_download_info)
        .toList();
  }

  @protected
  List<DartXetUploadInfo> dco_decode_list_dart_xet_upload_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_dart_xet_upload_info).toList();
  }
  ...
  DartXetDownloadInfo sse_decode_dart_xet_download_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_destinationPath = sse_decode_String(deserializer);
  ...
  @protected
  DartXetUploadInfo sse_decode_dart_xet_upload_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_hash = sse_decode_String(deserializer);
    var var_fileSize = sse_decode_u_64(deserializer);
    return DartXetUploadInfo(hash: var_hash, fileSize: var_fileSize);
  }
  ...
  List<DartXetDownloadInfo> sse_decode_list_dart_xet_download_info(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DartXetDownloadInfo>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_dart_xet_download_info(deserializer));
    }
    return ans_;
  }

  @protected
  List<DartXetUploadInfo> sse_decode_list_dart_xet_upload_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DartXetUploadInfo>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_dart_xet_upload_info(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  void sse_encode_DartFn_Inputs__Output_dart_token_info_AnyhowException(
    FutureOr<DartTokenInfo> Function() self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
      encode_DartFn_Inputs__Output_dart_token_info_AnyhowException(self),
      serializer,
    );
  }
  ...
  @protected
  void sse_encode_dart_token_info(
    DartTokenInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_dart_xet_download_info(
    DartXetDownloadInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.destinationPath, serializer);
    sse_encode_String(self.hash, serializer);
    sse_encode_u_64(self.fileSize, serializer);
  }

  @protected
  void sse_encode_dart_xet_upload_info(
    DartXetUploadInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.hash, serializer);
  ...
  void sse_encode_list_dart_xet_download_info(
    List<DartXetDownloadInfo> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_dart_xet_download_info(item, serializer);
    }
  }

  @protected
  void sse_encode_list_dart_xet_upload_info(
    List<DartXetUploadInfo> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_dart_xet_upload_info(item, serializer);
    }
  }
